 ...
 */
final class Version20231005180811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, librairie_id INTEGER DEFAULT NULL, description VARCHAR(255) NOT NULL, auteur VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, CONSTRAINT FK_AC634F99330C7BB3 FOREIGN KEY (librairie_id) REFERENCES librairie (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
